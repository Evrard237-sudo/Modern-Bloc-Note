...
import com.archcomp.notesyttutorial.Adapter.NotesAdapter
import com.archcomp.notesyttutorial.Database.NoteDatabase
import com.archcomp.notesyttutorial.Models.Note
import com.archcomp.notesyttutorial.Models.NoteViewModel
...
class MainActivity : AppCompatActivity(), NotesAdapter.NotesClickListener, PopupMenu.OnMenuItemClickListener {
    ...
    override fun onitemClicked(note: Note) {
        ...
        intent.putExtra("current_data", note)
